...
import { currencyCacheMiddleware } from "./cache/currency_cache_middleware";
...
route.get(`${baseUrl}rates/:source`, (req:Request,res:Response,next:NextFunction)=>currencyCacheMiddleware(req,res,next,cache), (req: Request, res: Response) => controller.getRates(req, res))
